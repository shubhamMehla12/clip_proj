...
if __name__ == "__main__":
    ...
    queries = predict_step([CFG.image_path + '/134206.jpg'])
    
    print(queries[0])

    model,image_embeddings = load_model_n_image_emb(CFG.model_path)

    # print(type(image_embeddings),len(image_embeddings),len(image_embeddings[0]))
    # print(image_embeddings)
    
    # # Open a file for writing in binary mode
    # with open('../models/image_embeddings_cpu.pkl', 'wb') as f:
    #     # Use the pickle.dump() method to write the matrix to the file
